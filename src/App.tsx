...
const coursesData: CourseTrack[] = [
  {
    ...
    detailUrl: 'https://megazone-ai-ih-01.vercel.app'
  },
  {
    id: 'architect',
    trackCode: 'TRACK 02',
    ...
    detailUrl: 'https://megazone-ai-ih-02.vercel.app'
  },
  {
    id: 'security',
    trackCode: 'TRACK 03',
    ...
    detailUrl: 'https://megazone-ai-ih-03.vercel.app'
  },
  {
    id: 'data',
    trackCode: 'TRACK 04',
    ...
    detailUrl: 'https://megazone-ai-ih-04.vercel.app'
  }
];
...
const regCourseSteps: CurriculumStep[] = [
  {
    ...
    items: [
      ...
      'Gemini API 및 AI Studio 활용',
      'AI 데이터 분석을 위한 기초 역량 확보'
    ]
  },
  {
    stepNum: 2,
  ...
  {
    stepNum: 4,
    title: 'Python 데이터 프로그래밍',
    icon: <Laptop size={24} />,
    items: [
      'Python 문법 및 객체지향 프로그래밍',
      'NumPy · Pandas 기반 데이터 처리',
      '웹 크롤링 및 데이터 수집 자동화'
    ]
  },
  {
  ...
  {
    stepNum: 8,
    title: 'AWS 데이터 레이크 구축',
    icon: <FolderGit2 size={24} />,
    items: [
      'S3 · Glue · Athena 활용',
      'Lake Formation 기반 데이터 거버넌스',
      '클라우드 데이터 레이크 구축'
    ]
  },
  {
  ...
  },
  {
    ...
    items: [
      'Docker 기반 데이터 플랫폼 운영',
      'Git · GitHub Actions 활용',
...
const projCourseSteps: CurriculumStep[] = [
  {
    stepNum: 12,
    title: 'AI 데이터 플랫폼 프로젝트',
    icon: <Target size={24} />,
    items: [
      '클라우드 데이터 레이크 구축 프로젝트',
      '데이터 웨어하우스 및 BI 분석 환경 구현',
      '실시간 데이터 파이프라인 자동화 프로젝트'
    ]
  },
  {
    stepNum: 13,
            ...
            {regCourseSteps.map((s) => (
              <div key={s.stepNum} className="benefit-card flex flex-col justify-between p-7 md:p-8">
                <div>
                  ...
                  <h3>{s.title}</h3>
                  <ul className="space-y-3 mt-4 pt-4 border-t border-slate-200/80">
...
export default function App() {
  ...
  const handleFormSubmit = (e: React.FormEvent) => {
    ...
    try {
      ...
      payload.append('_form_id', '5b31b9ae19d70b7366da3f4ff6220a04');
      ...
      <header className="header" id="header">
        <div className="header-inner">
          <div className="header-left">
            <a href="https://megazone-ai-ih.vercel.app" className="logo-wrap" id="headerLogoLink">
              <img
            ...
            <nav className="gnb-nav">
              <a href="https://megazone-ai-ih-01.vercel.app">AI 에이전트</a>
              <a href="https://megazone-ai-ih-02.vercel.app">AI 아키텍트</a>
              <a href="https://megazone-ai-ih-03.vercel.app">AI 보안</a>
              <a href="https://megazone-ai-ih-04.vercel.app">AI 데이터</a>
              <a href="#faq">FAQ</a>
            </nav>
          </div>
          <div className="header-right">
            <a
              href="https://naver.me/FtGVQVzf"
              target="_blank"
        ...
        <div className={`mobile-drawer ${mobileMenuOpen ? 'open' : ''}`} id="mobileDrawer">
          <a href="https://megazone-ai-ih-01.vercel.app" onClick={() => setMobileMenuOpen(false)}>AI 에이전트</a>
          <a href="https://megazone-ai-ih-02.vercel.app" onClick={() => setMobileMenuOpen(false)}>AI 아키텍트</a>
          <a href="https://megazone-ai-ih-03.vercel.app" onClick={() => setMobileMenuOpen(false)}>AI 보안</a>
          <a href="https://megazone-ai-ih-04.vercel.app" onClick={() => setMobileMenuOpen(false)}>AI 데이터</a>
        ...
        <div className="container">
          ...
          <div className="track-header-wrap text-center flex flex-col items-center justify-center mb-4">
            ...
            <h1 className="hero-title text-center">
              <span className="text-lg md:text-xl font-bold text-slate-300 block mb-1">하이브리드 클라우드 기반</span>
              <span className="highlight-cyan">AI 데이터</span> 엔지니어 양성과정  
            </h1>
            <p className="text-base md:text-xl font-medium text-slate-200 max-w-3xl mx-auto mt-2 leading-relaxed text-center">
              SQL·Spark·Kafka·Airflow 기반 End-to-End<br />
              데이터 파이프라인을 다루는 데이터 엔지니어로 성장
            </p>

            {/* Tags */}
            <div className="flex flex-wrap justify-center items-center gap-2 my-5 max-w-3xl mx-auto text-center">
              {['Python·SQL', 'Apache Spark', 'Kafka', 'Airflow', 'AWS Data Lake', 'Redshift·BI'].map((tag, idx) => (
          ...
          <p className="hero-desc text-slate-300 max-w-3xl mx-auto mb-8 text-base md:text-lg leading-relaxed">
            리눅스·SQL·Python 기초부터 Spark·Kafka·Airflow 기반 대용량·실시간 데이터 처리, AWS 데이터 레이크·DW 구축까지 — End-to-End 데이터 파이프라인을 설계·운영하는 실무형 데이터 엔지니어를 양성합니다.
          </p>
          ...
          <div className="track-cards-grid" id="trackCardsGrid">
            <div className="ncloud-card card-cyan reveal-item reveal-delay-1">
              <div>
                ...
                <h3 className="card-title">AI의 성능은 데이터가 결정합니다</h3>
                <p className="card-text">
                  좋은 AI 서비스의 전제는 잘 설계된 데이터 파이프라인입니다. AI 확산과 함께 데이터 엔지니어링 수요가 동반 성장하고 있습니다.
                </p>
              </div>
            </div>
            ...
            <div className="ncloud-card card-navy reveal-item reveal-delay-2">
              <div>
                ...
                <h3 className="card-title">데이터 엔지니어, 꾸준한 상위 수요 직군</h3>
                <p className="card-text">
                  데이터 엔지니어는 분석가 대비 공급이 적어, 파이프라인 구축 경험을 갖춘 주니어에 대한 수요가 꾸준합니다.
                </p>
              </div>
            </div>
            ...
            <div className="ncloud-card card-purple reveal-item reveal-delay-3">
              <div>
                ...
                <h3 className="card-title">클라우드 데이터 스택이 표준</h3>
                <p className="card-text">
                  기업 데이터 플랫폼이 AWS 등 클라우드로 이동하면서, 클라우드 네이티브 데이터 역량이 채용의 기준이 되고 있습니다.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          ...
          <div className="why-megazone-grid">
            <div className="why-megazone-card reveal-item reveal-delay-1">
              ...
              <div className="why-card-sub">기초부터 분산 처리까지</div>
              <p className="why-card-desc">
                리눅스·SQL·Python에서 Spark 대용량 분산 처리까지 단계별로 완주합니다.
              </p>
            </div>

            <div className="why-megazone-card reveal-item reveal-delay-2">
              <div className="why-card-title">02</div>
              <div className="why-card-sub">AWS 데이터 플랫폼 실전</div>
              <p className="why-card-desc">
                S3·Glue·Athena 데이터 레이크와 Redshift 기반 DW·BI 환경을 직접 구축합니다.
              </p>
            </div>

            <div className="why-megazone-card reveal-item reveal-delay-3">
              <div className="why-card-title">03</div>
              <div className="why-card-sub">실시간 파이프라인</div>
              <p className="why-card-desc">
                Airflow 워크플로우 자동화와 Kafka·Spark Streaming으로 실시간 데이터를 다룹니다.
              </p>
            </div>

            <div className="why-megazone-card reveal-item reveal-delay-4">
              <div className="why-card-title">04</div>
              <div className="why-card-sub">End-to-End 프로젝트</div>
              <p className="why-card-desc">
                수집부터 시각화까지, 전체 데이터 흐름을 완성하는 플랫폼 프로젝트를 수행합니다.
              </p>
            </div>
          </div>
        </div>
      ...
      <footer className="footer">
        <div className="container footer-inner">
          <div>
            ...
            <p>AI Campus · K-Digital Training | 운영/관리 담당자 : 한인호</p>
